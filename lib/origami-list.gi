...
# A) Alexander Mednykh, Counting non-equivalen coverings and non-isomorphic maps for Riemann surfaces (2005), Theorem 1
...
# Function 1: Let b be a non-negative integer. HowManySubgroups(b, r) is the list a1...ab where ai is the number of index i subroups in F. This list is empty when b is zero.
...
# Function 2: Let d be a positive integer and Z the cyclic group of order d. HowManyEpi(r, d) is the number of epimorphisms from F onto Z.
...
# Function 3: Let n be a positive integer. HowManyConjugatedSubgroups(n, r) is the number of conjugacy classes of subgroups of index n in F.
...
# Source: This is Theorem 1 in the (A) + index rank formula.
