...
#! @Returns A permutation
#! @Description
#! This returns the vertical permutation $\sigma_y$ of the dessin.
#!
#! @BeginExampleSession
#! gap> D:=Dessin((1,2,3),(2,3), 3);
#! Dessin((1,2,3), (2,3) ,3)
...
#! @Returns A boolean
#! @Description
#! This checks whether the dessin is connected, so whether the group generated by $sigma_x$ and $sigma_y$ acts transitively on $\{1, \dots, \mathrm{deg}(D)\}$.
#! @BeginExampleSession
#! gap> D:=Dessin((1,2,3),(2,3), 3);
#! Dessin((1,2,3), (2,3), 3)
