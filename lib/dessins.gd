...
#! @Description
#! This returns the permutation <M>\sigma_0</M> of the dessin that corresponds to the black vertices.
#! @Label
#! @BeginExampleSession
...
#! @Returns A permutation
#! @Description
#! This returns the permutation <M>\sigma_1</M> of the dessin that corresponds to the white vertices.
#! @Label
#! @BeginExampleSession
#! gap> D := Dessin((1,2,3), (2,3), 3);
#! Dessin((1,2,3), (2,3) ,3)
...
#! the permutations should act transitively on <M>\{1, \ldots, d\}</M>.
#! @Label
#! @BeginExampleSession
#! gap> D := Dessin((1,2,3), (2,3), 3);
#! Dessin((1,2,3), (2,3), 3)
...
#! @Description
#! This function calculates the genus of the dessin (so the genus of the underlying closed Riemann
#! surface).
#! @BeginExampleSession
#! gap> D := Dessin((1,2,3), (2,3), 3);
#! Dessin((1,2,3), (2,3), 3)
...
#! @Returns A boolean
#! @Description
#! This checks whether the dessin is connected, so whether the group generated by <M>\sigma_0</M> and
#! <M>\sigma_1</M> acts transitively on <M>\{1, \ldots, {\rm deg}(D)\}</M>.
#! @Label
#! @BeginExampleSession
#! gap> D := Dessin((1,2,3), (2,3), 3);
#! Dessin((1,2,3), (2,3), 3)
...
#! the sense that a component of degree <M>d</M> only uses letters in <M>\{1, \ldots, d\}</M> in the permutations.
#! @BeginExampleSession
...
#! are "normalized" in the sense that a component of degree <M>d</M> only uses letters in <M>\{1, \ldots, d\}</M>
#! the permutations.
#! @BeginExampleSession
