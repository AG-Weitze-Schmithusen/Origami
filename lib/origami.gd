...
#! @Description
#! Calculates the index of the monodromy group, i.e. the group generated by the
#! two permutations $\sigma_x$ and $\sigma_y$ in the symmetric group $S_d$ where
#! $d$ is the degree of the Origami.
...
DeclareGlobalFunction("CalcVeechGroupWithHashTablesAndBreak");
